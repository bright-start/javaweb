...
<ul>
    <li><a href="${pageContext.request.contextPath }/admin/category.jsp" target="mainFrame"><i></i>分类管理</a></li>
    <li><a href="${pageContext.request.contextPath }/GoodsServlet?action=getPageData&currentPage=1" target="mainFrame"><i></i>商品管理</a></li>
    <li></i><a href="${pageContext.request.contextPath }/admin/account.jsp" target="mainFrame"><i></i>用户管理</a></li>
</ul>
