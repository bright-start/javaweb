...
<%--
  	<c:forEach items="${allGoods }" var="goods" varStatus="status">
		<ul class="list_goods_ul">
        	...
        	<li><img src="${pageContext.request.contextPath }/admin/images/pimages/${goods.image }" name="image" alt=""></li>
        	<li>${goods.name }</li>
        	<li>${goods.price }</li>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/admin/search.jsp"></script>
<script>
    //分页
    $("#page").paging({
