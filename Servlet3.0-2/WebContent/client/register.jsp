...
<script type="text/javascript">
	function changeImage() {
		// 改变验证码图片中的文字
		document.getElementById("img").src = "${pageContext.request.contextPath}/CheckImagesServlet?time="
				+ new Date().getTime();
	}
</script>
</head>
					...
					<td style="padding: 30px"><h1>新用户注册</h1>
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							...
							<tr>
								...
								<img src="${pageContext.request.contextPath}/CheckImagesServlet" width="180"
